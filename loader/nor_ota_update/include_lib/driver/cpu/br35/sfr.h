...
typedef struct {
    __RW __u32(APA_VL0);    /* 00 */
    __WO __u32(APA_DCW);    /* 01 */
    __RO __u32(APA_DCR);    /* 02 */
    __RW __u32(APA_ADR);    /* 03 */
    __RW __u16(APA_LEN);    /* 04 */
    __RW __u16(APA_PNS);    /* 05 */
    __RW __u16(APA_HRP);    /* 06 */
    __RW __u16(APA_SWP);    /* 07 */
    __RW __u16(APA_SWN);    /* 08 */
    ...
    __RW __u32(APA_CON6);   /* 0F */
    __RW __u32(APA_CON7);   /* 10 */
