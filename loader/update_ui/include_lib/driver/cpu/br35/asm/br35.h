...
#define JL_VDOCOM_BASE                (hs_base + map_adr(0x19, 0x00))
#define JL_VDOCOM                     ((JL_VDOCOM_TypeDef  *)JL_VDOCOM_BASE)
...
typedef struct {
    ...
    __WO __u32 PND_CLR      ;
    __RW __u32 PND_IE       ;
    __RO __u32 RESERVED_03  ;
    __RW __u32 STA_CON      ;
    __RW __u32 OUT_FMT      ;
    __RW __u32 OUT_STRIDE   ;
    __RW __u32 WIN_BASE     ;
    __RW __u32 WIN_X        ;
    __RW __u32 WIN_Y        ;
    __RW __u32 NXT_LAYER_CNT;
    __RO __u32 CUR_LAYER_CNT;
    __RW __u32 NXT_INST_ADR ;
    __RO __u32 CUR_INST_ADR ;
    __RW __u32 SPH_CON      ;
    __RW __u32 SPH_INFO     ;
    __RW __u32 SPH_RD_ADR   ;
    __RW __u32 SPH_WR_ADR   ;
    __RW __u32 SPH_M00      ;
    __RW __u32 SPH_M01      ;
    __RW __u32 SPH_M02      ;
    __RW __u32 SPH_M03      ;
...
#define JL_GPU2D_BASE                      (hs_base + map_adr(0x20, 0x00))
#define JL_GPU2D                           ((JL_GPU2D_TypeDef			*)JL_GPU2D_BASE)

//............. 0x2100 - 0x21ff............ for jpg
typedef struct {
    __RW __u32 CON0        ;
    __RW __u32 CON1        ;
    __WO __u32 YDCVAL      ;
    ...
    __RW __u32 MCUCNT      ;
    __WO __u32 YUVLINE     ;
    __WO __u32 HUFFTBL_BASE;
    __WO __u32 CFGRAM_ADR  ;
    __WO __u32 CFGRAM_VAL  ;
} JL_JPG_TypeDef;

#define JL_JPG_BASE                      (hs_base + map_adr(0x21, 0x00))
...
#define JL_PSRAM_BASE                   (hs_base + map_adr(0x12, 0x00))
...
#define JL_ESPI_BASE                    (hs_base + map_adr(0x24, 0x00))
#define JL_ESPI                         ((JL_ESPI_TypeDef       *)JL_ESPI_BASE)

typedef struct {
    __RW __u32 CON  ;
} JL_ESPI_CK_TypeDef;
#define JL_ESPI_CK_BASE                 (hs_base + map_adr(0x25, 0x00))
#define JL_ESPI_CK                         ((JL_ESPI_CK_TypeDef       *)JL_ESPI_CK_BASE)
...
typedef struct {
    ...
    __RW __u32 ADC_CON2;
    __RW __u32 ADC_CON3;
    __RW __u32 ADC_CHLS0;
    __RW __u32 ADC_CHLS1;
    __RW __u32 ADC_CHLS2;
    __RW __u32 ADC_SPTS0;
    __RW __u32 ADC_SPTS1;
    __RW __u32 DMA_BADR;
    __RW __u32 DMA_BUFLEN;
    __RW __u32 DMA_WPTR;
    __RO __u32 ADC_RDATA;
    __RW __u32 ANA_CON0;
    __RW __u32 ANA_CON1;
} JL_ADC_TypeDef;
...
typedef struct {
    __RW __u32(APA_VL0);    /* 01 */
    __WO __u32(APA_DCW);    /* 02 */
    __RO __u32(APA_DCR);    /* 03 */
    __RW __u32(APA_ADR);    /* 04 */
    __RW __u16(APA_LEN);    /* 05 */
    __RW __u16(APA_PNS);    /* 06 */
    __RW __u16(APA_HRP);    /* 07 */
    __RW __u16(APA_SWP);    /* 08 */
    __RW __u16(APA_SWN);    /* 09 */
    __RW __u32(APA_CON0);   /* 0A */
    __RW __u32(APA_CON1);   /* 0B */
    __RW __u32(APA_CON2);   /* 0C */
    __RW __u32(APA_CON3);   /* 0D */
    __RW __u32(APA_CON4);   /* 0E */
    __RW __u32(APA_CON5);   /* 0F */
    __RW __u32(APA_CON6);   /* 10 */
    __RW __u32(APA_CON7);   /* 11 */
    __RO __u32(APA_CON8);   /* 11 */
} JL_APA_TypeDef;
