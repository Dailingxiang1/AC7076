...
int my_fread(FILE *file, void *buf, u32 len)
{
...
bool lrc_ui_show(int text_id, u8 encode_type, u8 *buf, int len)
{
    ...
    if (LRC_UTF16_S == encode_type) {
        ...
        ui_text_set_textw_by_id(text_id, (const char *)buf, len, FONT_ENDIAN_SMALL, FONT_DEFAULT | FONT_SHOW_MULTI_LINE | FONT_SHOW_SCROLL);
