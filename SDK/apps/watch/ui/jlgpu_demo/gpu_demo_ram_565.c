...
#if defined GPU_DEMO_RAM_565_ENABLE && GPU_DEMO_RAM_565_ENABLE
...
int gpu_demo_ram_565_task(void)
{
    printf(">>>>>>>>> %s()", __func__);
    int err;
    err = os_task_create(gpu_demo_ram_565, NULL, 10, 1024 * 5, 512, "gpu_demo_ram_565");
    if (err != OS_NO_ERR) {
