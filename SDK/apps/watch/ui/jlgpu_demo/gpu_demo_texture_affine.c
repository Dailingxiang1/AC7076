...
#if defined GPU_DEMO_TEXTURE_AFFINE_ENABLE && GPU_DEMO_TEXTURE_AFFINE_ENABLE
...
void gpu_demo_texture(void *p)
{
    ...
    img_user.rotate_cx = 25;
    img_user.rotate_cy = 25;
    img_user.rotate_dx = 125;
    img_user.rotate_dy = 125;
    img_user.rotate_angle = 90;
...
int gpu_demo_texture_affine_task(void)
{
    printf(">>>>>>>>> %s()", __func__);
    int err;
