...
#pragma bss_seg(".chgbox_wireless.data.bss")
#pragma data_seg(".chgbox_wireless.data")
#pragma const_seg(".chgbox_wireless.text.const")
#pragma code_seg(".chgbox_wireless.text")
#endif
#include "gpio.h"
