...
#pragma bss_seg(".chgbox_handshake.data.bss")
#pragma data_seg(".chgbox_handshake.data")
#pragma const_seg(".chgbox_handshake.text.const")
#pragma code_seg(".chgbox_handshake.text")
#endif
#include "gpio.h"
