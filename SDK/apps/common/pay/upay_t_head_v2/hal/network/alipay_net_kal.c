                             ...
                             unsigned int                    tolen)
{
    ...
    server_addr.sa_family = to->sa_family;
    /* server_addr.sin_port = htons(443); */
    ...
    memcpy(&server_addr.sa_data, to->data.sa_data, 14);
                               ...
                               unsigned int            *fromlen)
{
    ...
    if (from) {
        ...
        struct sockaddr server_addr;
        server_addr.sa_family = from->sa_family;
        /* server_addr.sin_port = htons(443); */
        /* server_addr.sin_port = htons(from->data.sin_data.port); */
        memcpy(&server_addr.sa_data, from->data.sa_data, 14);

        int addrlen = sizeof(server_addr);
        bytes_received = recvfrom(fd, mem, len, flags, &server_addr, (socklen_t *)&addrlen);
