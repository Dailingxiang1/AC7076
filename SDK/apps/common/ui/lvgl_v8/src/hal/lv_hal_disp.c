...
#elif LV_USE_GPU2D_JL
    driver->draw_ctx_init = lv_draw_jlgpu_ctx_init;
    driver->draw_ctx_deinit = lv_draw_jlgpu_ctx_deinit;
    driver->draw_ctx_size = sizeof(lv_draw_jlgpu_ctx_t);
    LV_LOG_USER("LV_USE_GPU2D_JL");
#else
