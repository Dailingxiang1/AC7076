...
#if LV_MEM_CUSTOM == 0
    //LV_ASSERT_MSG(!strcmp(os_current_task(), "ui"), "lv_mem_alloc can't multi thread access");
...
void lv_mem_monitor(lv_mem_monitor_t *mon_p)
{
    ...
    static unsigned int timeout_hdl;
    if (time_lapse(&timeout_hdl, 30000)) {
        LV_LOG_USER("[LV_MEM] total_size:%3dKB, cur_used:%3dKB, max_used:%3dKB, free_cnt/used_cnt:%3d/%3d, frag_pct:%2d%%, biggest_free_size:%3dKB \r\n",
