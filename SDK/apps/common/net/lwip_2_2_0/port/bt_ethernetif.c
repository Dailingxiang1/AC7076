...
#pragma bss_seg(".lwip_bt_ethernetif.data.bss")
#pragma data_seg(".lwip_bt_ethernetif.data")
#pragma const_seg(".lwip_bt_ethernetif.const")
#pragma code_seg(".lwip_bt_ethernetif.text")
#endif
/* Includes ------------------------------------------------------------------*/
#include "lwip/err.h"
#include "etharp.h"
