...
static const char the_original_Name[] = "AC707_WATCH";//"Accessory- Find My.";
 ...
 */
/*************************************************************************************************/
void fmna_lib_crypto_state_callback(u8 state)
{
    if (state) {

        clock_alloc("FMNA", 160000000);
    } else {
