...
#define RCSP_BLE_CLIENT_EN 										0
#define RCSP_MULTI_BLE_MASTER_NUMS         						2 //range(0~2)
...
#define RCSP_MSG_DISTRIBUTION_VER								RCSP_MSG_DISTRIBUTION_VER_DEFAULT		//默认消息分发管理
...
// 手表SDK RCSP功能配置
#elif ((RCSP_MODE == RCSP_MODE_WATCH) && (!TCFG_UI_ENABLE))
...
#define RCSP_BLE_CLIENT_EN 										1
#define RCSP_FILE_OPT                                           1
#define RCSP_APP_RTC_EN                                         1
#if TCFG_APP_RTC_EN
// 0 - 旧闹钟，只支持提示音闹铃
...
#define RCSP_ADV_KARAOKE_SET_ENABLE								0		// 卡拉OK设置
#define RCSP_ADV_KARAOKE_EQ_SET_ENABLE							0		// 卡拉OK EQ设置
#define RCSP_ADV_DEVICE_CONFIG_GET								1		// 开启支持手表信息获取
#else
#define RCSP_ADV_NAME_SET_ENABLE        						0		// 蓝牙名设置
#define RCSP_ADV_KEY_SET_ENABLE         						0		// 按键设置
#define RCSP_ADV_LED_SET_ENABLE         						0		// 灯光设置
...
#if (defined TCFG_CSC_BT_APP) && TCFG_CSC_BT_APP
#define RCSP_SCREEN_UI_BOX_SCREEN_SAVER                              1       //屏幕保护程序
#define RCSP_SCREEN_UI_BOX_BOOT_ANIMATION                            0       //开机动画
#define RCSP_SCREEN_UI_BOX_WALLPAPER                                 0       //墙纸
#endif
...
#if (RCSP_MODE == RCSP_MODE_WATCH)
#define		RCSP_SDK_TYPE		RCSP_SDK_TYPE_AC701X_WATCH
#else
#define		RCSP_SDK_TYPE		RCSP_SDK_TYPE_AC696X
#endif
#elif (defined CONFIG_CPU_BR30)
#define		RCSP_SDK_TYPE		RCSP_SDK_TYPE_AC697X
#elif (defined CONFIG_CPU_BR35)
#if (defined TCFG_CSC_BT_APP) && TCFG_CSC_BT_APP
#define		RCSP_SDK_TYPE		RCSP_SDK_TYPE_CHARGING_CASE
#else
#define		RCSP_SDK_TYPE		RCSP_SDK_TYPE_707N_WATCH
#endif
#else
#define		RCSP_SDK_TYPE		RCSP_SDK_TYPE_AC693X
#endif
...
#if TCFG_EARPHONE_PROTOCOL
#define RCSP_MULTI_BLE_MASTER_NUMS								1
#else
...
#if TCFG_EARPHONE_PROTOCOL
#define RCSP_MULTI_BLE_SLAVE_NUMS								1
#else
...
#ifndef RCSP_ADV_DEVICE_CONFIG_GET
#define RCSP_ADV_DEVICE_CONFIG_GET								0
#endif
