...
#define		RCSP_SDK_TYPE_AC701X_WATCH					0x9
#define		RCSP_SDK_TYPE_MANIFEST_EARPHONE				0xA
#define		RCSP_SDK_TYPE_MANIFEST_SOUNDBOX				0xB
#define     RCSP_SDK_TYPE_CHARGING_CASE                 0xC
#define     RCSP_SDK_TYPE_707N_WATCH                    0xD
...
#define    JL_OPCODE_APP_RECORDING                                  0x04
#define    JL_OPCODE_APP_RECORD_END                                 0x05
...
#define    JL_OPCODE_AI_DIAL						                0x32
#define    JL_OPCODE_COMMON_INFO_SET						        0x33
