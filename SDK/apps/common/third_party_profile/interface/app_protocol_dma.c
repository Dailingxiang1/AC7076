...
#pragma bss_seg(".app_protocol_dma.data.bss")
#pragma data_seg(".app_protocol_dma.data")
#pragma const_seg(".app_protocol_dma.text.const")
#pragma code_seg(".app_protocol_dma.text")
#endif
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
