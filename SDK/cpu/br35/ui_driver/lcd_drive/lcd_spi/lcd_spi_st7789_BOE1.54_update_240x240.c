...
#pragma bss_seg(".lcd_spi_st7789_BOE1.54_update_240x240.data.bss")
#pragma data_seg(".lcd_spi_st7789_BOE1.54_update_240x240.data")
#pragma const_seg(".lcd_spi_st7789_BOE1.54_update_240x240.text.const")
#pragma code_seg(".lcd_spi_st7789_BOE1.54_update_240x240.text")
#endif
/*
...
{
    imd_spi_tx_cmd(0x28, 1);
    imd_spi_tx_cmd(0x10, 1);
    lcd_dly_2ms(120 / 2);	// delay 120ms
}
...
{
    imd_spi_tx_cmd(0x11, 1);
    lcd_dly_2ms(120 / 2);	// delay 120ms
    imd_spi_tx_cmd(0x29, 1);
}
