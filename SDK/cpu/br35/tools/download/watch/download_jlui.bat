...
copy /B JL+sidebar+font mode.bin

..\..\fat_comm.exe -pad-backup2 -force-align-fat -out watch.bin -image-size 8 -filelist  watch watch1 -remove-empty -remove-bpb -mark-bad-after 0xD8000  -address 0
